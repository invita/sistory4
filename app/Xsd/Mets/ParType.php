...
class ParType
{
     ...
     */
    public function addToSeqElName(\App\Xsd\Mets\SeqType $seqElName)
    {
     ...
     * @return boolean
     */
    public function issetSeqElName($index)
    {
        return isset($this->seqElName[$index]);
    }
     ...
     * @return void
     */
    public function unsetSeqElName($index)
    {
        unset($this->seqElName[$index]);
    }
     ...
     * @return self
     */
    public function setSeqElName(array $seqElName)
    {
        $this->seqElName = $seqElName;
        return $this;
    }
