var F = function(args){
    ...
    var fieldData = actionsForm.addInput({name:"data", value:rowValue.data, type:"text", caption:si4.translate("field_data"), readOnly: true});
    ...
    var fieldFrontendFields = frontendForm.addInput({name:"frontendFields", value: "", type:"text",
        caption:si4.translate("field_frontendFields"), isArray: true });
